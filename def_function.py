database = {} #Database that contains all the information of the categories
class budget:  #this 
    def __init__(self,needs,balance):
        self.needs = needs
        self.balance = balance
        
    def deposit(deposit_amt,balance): #where deposit_amt is the new amount deposited, balance is the balance in database
        balance += deposit_amt #balance = balance + deposit_amt
        return balance
